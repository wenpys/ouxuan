...
import deling.cellcom.com.cn.widget.timepickerview.TimePickerView2.Type;
import deling.cellcom.com.cn.widget.timepickerview.adapter.NumericWheelAdapter;
...
//	private WheelView wv_mins;
	private String timeClass[]={"当月","全年"};
...
//		wv_day = (WheelView) view.findViewById(R.id.day);
//		wv_day.setAdapter(new WheelAdapter<String>() {
//
//			@Override
//			public int getItemsCount() {
//				// TODO Auto-generated method stub
//				return timeClass.length;
//			}
//
//			@Override
...
//
//			@Override
//			public int indexOf(String str) { //这里对应 onitemselecter的位置
//				// TODO Auto-generated method stub
//				if(str.equals(timeClass[0])){
//					return 1;
//				}else{
//					return 0;
//				}
...
//		wv_day.setCurrentItem(0);
		...
		wv_day.setLabel(context.getString(R.string.pickerview_hao));
...
//		wv_mins.setCyclic(cyclic);
	...
	public String getTime() {
		...
		int dayCurrentItem=wv_day.getCurrentItem()+1;
			sb.append((wv_year.getCurrentItem() + startYear)).append("-")
			.append((wv_month.getCurrentItem() + 1)).append("-")
			.append(dayCurrentItem);
