...
public class ActionSheet {
	...
	public static Dialog showSheet(Context context,
		...
		final LinearLayout mShare = (LinearLayout) layout.findViewById(R.id.share);
		final LinearLayout wechat = (LinearLayout) layout.findViewById(R.id.ll_wechat);
		final LinearLayout wxcircle = (LinearLayout) layout.findViewById(R.id.ll_wxcircle);
		final ImageView mWeChat = (ImageView) layout.findViewById(R.id.wechat);
		final ImageView mWxCircle = (ImageView) layout.findViewById(R.id.wx_circle);
		...
		if (type.equals("1")) {
			...
			tv_preview.setVisibility(View.GONE);
			mShare.setVisibility(View.VISIBLE);
			wxcircle.setVisibility(View.GONE);
		}
		...
		mWxCircle.setOnClickListener(new OnClickListener() {
