...
/**
 * 
 * @author zsw	ListView	寮瑰嚭绐楀彛
 *
 */

/**
 * 
 * @author zsw	ListView	弹出窗口
 *
 */
public class ListViewPopupWindow {
	...
	private void initView(){
		View view = LayoutInflater.from(context).inflate(R.layout.app_listview_popup, null);
	 ...
	 * @param y
	 */
	public void show(View parent, int gravity, int x, int y,int width,int height){
