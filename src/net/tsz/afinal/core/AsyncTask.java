 ...
 * core/java/android/os/AsyncTask.java 修改了线程池属性，让并发线程按顺序执行
 * 
 * @author michael
 * 
 * @param <Params>
...
public abstract class AsyncTask<Params, Progress, Result> {
	...
	private Result postResult(Result result) {
		...
		// A generic array of Result is created for a varargs parameter
	...
	// The enum constant PENDING needs a corresponding case label in this enum
	// switch on AsyncTask<Params,Progress,Result>.Status
	...
	private static class InternalHandler extends Handler {
		@SuppressWarnings("unchecked")
		// The method finish(Object) belongs to the raw type AsyncTask.
		// References to generic type AsyncTask<Params,Progress,Result> should
		// be parameterized
		@Override
		public void handleMessage(Message msg) {
			@SuppressWarnings("rawtypes")
			// AsyncTask.AsyncTaskResult is a raw type. References to generic
			// type AsyncTask<Params,Progress,Result>.AsyncTaskResult<Data>
	...
	private static class AsyncTaskResult<Data> {
		// AsyncTask is a raw type. References to generic type
		// AsyncTask<Params,Progress,Result> should be parameterized
		@SuppressWarnings("rawtypes")
