...
public class FinalDb {
	...
	// ManyToOneLazyLoader is a raw type. References to generic type
	// ManyToOneLazyLoader<M,O> should be parameterized
	// Type safety: The constructor ManyToOneLazyLoader(Object, Class, Class,
	// FinalDb) belongs to the raw type ManyToOneLazyLoader. References to
	// generic type ManyToOneLazyLoader<M,O> should be parameterized
	...
	// Type safety: The method setList(List) belongs to the raw type
	// OneToManyLazyLoader. References to generic type OneToManyLazyLoader<O,M>
