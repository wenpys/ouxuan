...
public class CellComAjaxResultParseGSON extends CellComAjaxResultParse {
	...
	public <T> T read(Class<T> clazz) {
		...
		java.lang.reflect.Type type = new com.google.gson.reflect.TypeToken<T>() {
		}.getType();
		// Gson gson = new Gson();
	 ...
	 * @date 2011-08-06
	 */
	public class DateDeserializerUtils implements
	...
	public Object[] readOnlyLayer(String[] xmlparams) {
		...
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				// Iterator is a raw type. References to generic type
