...
public class XmlParser extends BaseParser{
	...
	protected ContentHandler newHandler(final String[] params,@SuppressWarnings("rawtypes") final List infos, final StringBuffer currentState, final StringBuffer currentErrorcode ,final StringBuffer currentMsg){	
		...
		info.setEndElementListener(
				new EndElementListener(){
					@SuppressWarnings("unchecked")//类型转换
